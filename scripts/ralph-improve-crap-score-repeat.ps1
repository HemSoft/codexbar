# ralph-improve-crap-score-repeat.ps1 — Repeated CRAP score improver.
# Version: 1.3.0
...
if ($Help) {
    Write-Host ""
    Write-Host "ralph-improve-crap-score-repeat.ps1 - Repeated CRAP Score Improver" -ForegroundColor Cyan
    Write-Host "Runs ralph-improve-crap-score.ps1 N times in autopilot mode."
    ...
    Write-Host "  ralph-improve-crap-score-repeat"
    Write-Host "  ralph-improve-crap-score-repeat -Times 5"
    Write-Host "  ralph-improve-crap-score-repeat -Times 10 -Model sonnet -WorkUntil 08:00"
    Write-Host "  ralph-improve-crap-score-repeat -Times 3 -Agents auditor-crap-score"
    Write-Host ""
    exit 0
}

$scriptDir = $PSScriptRoot
$targetScript = Join-Path $scriptDir "ralph-improve-crap-score.ps1"
if (-not (Test-Path $targetScript)) {
    Write-Host "ERROR: ralph-improve-crap-score.ps1 not found at: $targetScript" -ForegroundColor Red
    exit 1
}
...
for ($i = 1; $i -le $Times; $i++) {
    ...
    Write-Host "== CRAP score improvement run $i of $Times" -ForegroundColor Cyan
    Write-Host "====================================" -ForegroundColor Cyan
...
Write-Host "== All $Times CRAP score improvement runs complete!" -ForegroundColor Green
Write-Host "====================================" -ForegroundColor Green
